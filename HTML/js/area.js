...
function AreaCtrlNormal(strP, strC, strA){
	this.value="";
	...
	this.html = '<span>'+strP+'<select class="form-control" name="Province" id="prov'+this.randomNum+'" '+onchgProvincesStr+' ></select></span>';
	if (this.level>1){this.html += '<span>'+strC+'<select class="form-control" name="City" id="city'+this.randomNum+'" '+onchgCityStr+' ></select></span>';}
	if (this.level>2){this.html += '<span>'+strA+'<select class="form-control" name="Area" id="area'+this.randomNum+'"></select></span>';}
...
function AreaCtrlDisabled(strP,strC,strA){
	this.value="";
	this.randomNum = parseInt(Math.random()*100000000);
	this.level = arguments.length;
	var onchgProvincesStr = "";
	...
	this.html = '<span>'+strP+'<select class="form-control" name="Province" id="prov'+this.randomNum+'" '+onchgProvincesStr+' disabled></select></span>';
	if (this.level>1){this.html += '<span>'+strC+'<select class="form-control" name="City" id="city'+this.randomNum+'" '+onchgCityStr+' disabled></select></span>';}
	if (this.level>2){this.html += '<span>'+strA+'<select class="form-control" name="Area" id="area'+this.randomNum+'" disabled></select></span>';}
