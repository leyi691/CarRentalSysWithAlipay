    ...
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<%=basePath%>/doSysAdmin?op=list">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">系统管理员主页</h1>
                <button type="button" class="btn btn-primary" onclick="sysDoEdit()">点我开始修改信息</button>
            </div>
            <%
                // 获取servlet传来的个人信息
            ...
            <form action="<%=basePath%>/doSysAdmin?op=editSelf" method="POST">
                <div class="container">
                    <div class="row">
                        <!--  隐式传送userId  -->
                        <input type="hidden" name="inputAdminId" value="<%=admin.getAdminId()%>">
                        <div class="mb-3 col-6">
                            <label for="inputUsername" class="form-label">用户名：</label>
                            <input type="text" class="form-control" id="inputUsername" name="inputUsername"
                                   value="<%=admin.getAdminUsername()%>" disabled>
                            <div class="form-text text-danger">用户名不可修改</div>
                        </div>
                        ...
                        <!-- 左侧开始：昵称 性别 手机号 -->
                        <div class="col-6">
                                <label for="inputAdminName" class="form-label">昵称：</label>
                                <input type="text" class="form-control" id="inputAdminName" name="inputAdminName"
                                       value="<%=admin.getAdminName()%>" disabled>
                        </div>
                        <div class="col-6">
                                <label for="inputPhoneNumber" class="form-label">手机号：</label>
                                <input type="text" name="inputPhoneNumber" id="inputPhoneNumber" class="form-control mb-3"
                                       value="<%=admin.getAdminPhoneNumber()%>" disabled>
                        </div>
