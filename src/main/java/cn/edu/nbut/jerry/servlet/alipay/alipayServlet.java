package cn.edu.nbut.jerry.servlet.alipay;
...
@WebServlet(name = "支付宝处理servlet", urlPatterns = "/doAlipay")
public class alipayServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("returnURL".equals(action)) {
            // 同步跳转到用户订单页面，显示用户当前订单

        } else if ("getTradeStatus".equals(action)) {
